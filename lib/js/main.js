...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Section 4 — Solutions (4-column, centred header, home page only)
  ...
  // Section 6 — Selected Blogs (pulls latest from BLOG_SECTIONS; hidden when empty)
  if (typeof renderCardSection === "function") {
    const latestBlogs = (typeof BLOG_SECTIONS !== "undefined")
      ? BLOG_SECTIONS.flatMap(s => s.blogs || []).slice(0, 3)
      : [];
  ...
  // Blog page — domain-based blog sections
  ...
  if (typeof renderCardSection === "function" && document.getElementById("services-root") && typeof SERVICES !== "undefined") {
    renderCardSection({
      mountId:  "services-root",
      bg:       "bg-white",
      title:    "Our Services",
      subtitle: "Comprehensive technology solutions tailored to your business.",
      items:    SERVICES,
      cardType: "solution",
      cols:     3,
      basePath: p,
