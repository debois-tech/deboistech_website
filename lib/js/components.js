...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const active = (name) => {
    const pages = name === "blogs.html" ? ["blogs.html", "blog-detail.html", "blog-studio.html"] : [name];
    return pages.includes(page) ? "text-gray-900" : "text-gray-600 hover:text-gray-900";
  };
  ...
  if (ftRoot) {
    ...
    const faqHref     = `${pageHref}/faq.html`;
    const privacyHref = `${pageHref}/privacypolicy.html`;
      ...
      <footer class="bg-primary-900 px-4 py-16 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-7xl">
          <div class="flex flex-col gap-12 lg:flex-row lg:gap-8">
            ...
            <div class="grid grid-cols-2 gap-8 lg:flex lg:flex-1 lg:gap-8">
              ...
              <div class="lg:flex-1 lg:order-3">
                <h4 class="text-sm font-bold text-white">Resources</h4>
                <ul class="mt-4 space-y-3">
                  <li><a href="${pageHref}/blogs.html" class="text-sm text-gray-400 hover:text-white">Blog</a></li>
                  <li><a href="${faqHref}" class="text-sm text-gray-400 hover:text-white">FAQ's</a></li>
                </ul>
              </div>
              <div class="lg:flex-1 lg:order-2">
                <h4 class="text-sm font-bold text-white">Services</h4>
                <ul class="mt-4 space-y-3">
                  <li><a href="${pageHref}/services.html#build" class="text-sm text-gray-400 hover:text-white">Build</a></li>
                  <li><a href="${pageHref}/services.html#scale" class="text-sm text-gray-400 hover:text-white">Scale</a></li>
                  <li><a href="${pageHref}/services.html#accelerate" class="text-sm text-gray-400 hover:text-white">Accelerate</a></li>
                </ul>
              </div>
              <div class="lg:flex-1 lg:order-4">
          ...
          <div class="mt-12 border-t border-primary-700 pt-8 sm:flex sm:items-center sm:justify-between">
            <p class="text-xs text-gray-500">&copy; 2026 deboistech. All rights reserved.</p>
            <div class="mt-4 flex gap-6 sm:mt-0">
              <a href="${privacyHref}" class="text-xs text-gray-500 hover:text-white">Privacy Policy</a>
